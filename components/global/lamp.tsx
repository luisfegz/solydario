  ...
  return (
    <LampContainer>
      ...
      >
        ...
        Al elegir energía solar, no solo reduces costos, sino que también contribuyes a un planeta más limpio. ¡Hagamos juntos el cambio hacia un futuro sostenible!
      </motion.h1>
    </LampContainer>
  )
}
